defmodule TaskForest.Encryption do
  @moduledoc """
  ...
  See https://github.com/dwyl/phoenix-ecto-encryption-example/blob/main/lib/encryption/aes.ex
  ...
  defp encryption_keys do
    Application.get_env(:task_forest, TaskForest.Encryption)[:keys]
  end
